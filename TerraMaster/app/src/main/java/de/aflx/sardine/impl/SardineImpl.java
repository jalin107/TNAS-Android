...
//				CoreConnectionPNames.CONNECTION_TIMEOUT, 1000);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.aflx.sardine.Sardine#getResources(String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.aflx.sardine.Sardine#list(String)
	 */
...
//		}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.aflx.sardine.Sardine#lock(String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.aflx.sardine.Sardine#unlock(String,
	 *      String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.aflx.sardine.Sardine#get(String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.aflx.sardine.Sardine#get(String, Map)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.aflx.sardine.Sardine#put(String, byte[],
	 *      String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.aflx.sardine.Sardine#put(String,
	 *      InputStream)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.aflx.sardine.Sardine#delete(String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.aflx.sardine.Sardine#move(String,
	 *      String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.aflx.sardine.Sardine#copy(String,
	 *      String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.aflx.sardine.Sardine#createDirectory(String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.aflx.sardine.Sardine#exists(String)
	 */
