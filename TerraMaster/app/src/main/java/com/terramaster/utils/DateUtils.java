...
public class DateUtils {
    ...
    public static final SimpleDateFormat SQL_DATE_SDF = new SimpleDateFormat(
            "yyyy-MM-dd HH:mm:ss");
    ...
    /**
     * <p>
     * Checks if a calendar date is yesterday.
     * </p>
     *
     * @param cal the calendar, not altered, not null
     * @return true if cal date is today
    ...
    public static boolean isYesterday(Calendar cal) {
        ...
        return isSameDay(cal, calendarYesterday);
    }

    /**
     * <p>
     * Checks if a calendar date is tomorrow.
     * </p>
     *
     * @param cal the calendar, not altered, not null
     * @return true if cal date is today
    ...
    public static boolean isTomorrow(Calendar cal) {
        ...
        return isSameDay(cal, calendarTomorrow);
    }
